...
const SizedBox(width: 12),
Text("${controller.orderCountMap[c.i
d] ?? 0}",
style: const TextStyle(
color: Colors.orange,
fontWeight: FontWeight.bold,
...
decoration: BoxDecoration(
color: isCurrent ? const Color(0xFF4318FF) :
Colors.white,
...
BoxShadow(
color: const
Color(0xFF4318FF).withOpacity(0.3),
...
child: Text("No orders found.", textAlign:
TextAlign.center),
)
: ListView.separated(
shrinkWrap: true,
